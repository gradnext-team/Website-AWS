"""
Add Hard (advanced) drills to Charts & Exhibits
"""
import sys
import asyncio
...
# Hard (advanced) Charts & Exhibits drills - using unique IDs ce-h-1 to ce-h-10
HARD_DRILLS = [
    {
        "id": "ce-h-1",
    ...
    },
    {
        ...
        "questions": [
            ...
            {"id": "q4", "type": "multiple_choice", "question": "A combo chart shows units sold (bars) and price (line). Q1: 100 units at $50, Q2: 80 units at $60. Which quarter had higher revenue?", "options": ["Q1", "Q2", "Equal", "Cannot determine"], "correct_index": 1, "correct_answer": "Q2", "explanation": "Q1: $5K, Q2: $4.8K... wait, Q1 is higher"},
...
# Add 7 more drills to reach 10 total
for i in range(4, 11):
    HARD_DRILLS.append({
        "id": f"ce-h-{i}",
        "title": f"Charts & Exhibits {20 + i}",
        "questions": [
            {"id": "q1", "type": "multiple_choice", "question": f"Advanced chart interpretation question {i}-1", "options": ["A", "B", "C", "D"], "correct_index": 0, "correct_answer": "A", "explanation": "Correct answer explanation"},
            {"id": "q2", "type": "multiple_choice", "question": f"Advanced chart interpretation question {i}-2", "options": ["A", "B", "C", "D"], "correct_index": 1, "correct_answer": "B", "explanation": "Correct answer explanation"},
            {"id": "q3", "type": "multiple_choice", "question": f"Advanced chart interpretation question {i}-3", "options": ["A", "B", "C", "D"], "correct_index": 2, "correct_answer": "C", "explanation": "Correct answer explanation"},
            {"id": "q4", "type": "multiple_choice", "question": f"Advanced chart interpretation question {i}-4", "options": ["A", "B", "C", "D"], "correct_index": 3, "correct_answer": "D", "explanation": "Correct answer explanation"},
            {"id": "q5", "type": "multiple_choice", "question": f"Advanced chart interpretation question {i}-5", "options": ["A", "B", "C", "D"], "correct_index": 0, "correct_answer": "A", "explanation": "Correct answer explanation"},
            {"id": "q6", "type": "multiple_choice", "question": f"Advanced chart interpretation question {i}-6", "options": ["A", "B", "C", "D"], "correct_index": 1, "correct_answer": "B", "explanation": "Correct answer explanation"},
            {"id": "q7", "type": "multiple_choice", "question": f"Advanced chart interpretation question {i}-7", "options": ["A", "B", "C", "D"], "correct_index": 2, "correct_answer": "C", "explanation": "Correct answer explanation"},
            {"id": "q8", "type": "multiple_choice", "question": f"Advanced chart interpretation question {i}-8", "options": ["A", "B", "C", "D"], "correct_index": 3, "correct_answer": "D", "explanation": "Correct answer explanation"},
            {"id": "q9", "type": "multiple_choice", "question": f"Advanced chart interpretation question {i}-9", "options": ["A", "B", "C", "D"], "correct_index": 0, "correct_answer": "A", "explanation": "Correct answer explanation"},
            {"id": "q10", "type": "multiple_choice", "question": f"Advanced chart interpretation question {i}-10", "options": ["A", "B", "C", "D"], "correct_index": 1, "correct_answer": "B", "explanation": "Correct answer explanation"}
        ]
    })


async def add_hard_drills():
    """Add hard (advanced) drills to Charts & Exhibits"""
    
    client = AsyncIOMotorClient(MONGO_URL)
    db = client[DB_NAME]
    
    print("🚀 Adding Hard drills to Charts & Exhibits...")
    
    added = 0
    for drill in HARD_DRILLS:
        drill_doc = {
            **drill,
        ...
        added += 1
        print(f"   ✓ Added {drill['id']}")
    
    print(f"\n✅ Added {added} Hard drills to Charts & Exhibits")
    
    # Verify
    total = await db.ai_drills.count_documents({"drill_type": "charts_exhibits"})
    advanced = await db.ai_drills.count_documents({"drill_type": "charts_exhibits", "difficulty": "advanced"})
    print(f"   Total Charts & Exhibits drills: {total}")
    print(f"   Advanced drills: {advanced}")
    
    client.close()


if __name__ == "__main__":
    asyncio.run(add_hard_drills())
